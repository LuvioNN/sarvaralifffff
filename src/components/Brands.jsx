...
function Brands() {
	...
	function getBrands() {
		fetch('https://3f019a703d00d18f.mokky.dev/brands')
			.then(res => res.json())
		...
		<section className='brands'>
			<div className='container'>
				<div className='brands__wrap'>
					<div className='brands__alt'>
						<div className='brands__alt-one'>
							<div className='brands__data'>
								{brands.map(item => (
									<img src={item.img} alt='banner img' />
								))}
							</div>
						</div>
						<div className='brands__wrapp'>
							<button className='brands__wrapper'>
								<path
									fill-rule='evenodd'
									clip-rule='evenodd'
